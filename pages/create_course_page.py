...
class CreateCoursePage(BasePage):
    def __init__(self,page  ):
        ...
        self.create_course_estimate_time_input = page.get_by_test_id(
            'create-course-form-estimated-time-input').locator('input')
        self.create_course_description_input = page.get_by_test_id(
    ...
    def check_visible_create_course_form(
        ...
        expect(self.create_course_estimate_time_input).to_be_visible()
        expect(self.create_course_estimate_time_input).to_have_value(estimated_time)
    ...
    def fill_create_course_form(
        ...
        self.create_course_estimate_time_input.fill(estimated_time)
        expect(self.create_course_estimate_time_input).to_have_value(estimated_time)
    ...
    def click_create_exercise_button(self):
        expect(self.create_exercise_button).click()
