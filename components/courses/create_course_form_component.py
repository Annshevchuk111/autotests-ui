...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self,page:Page):
        ...
        self.estimate_time_input = page.get_by_test_id(
            'create-course-form-estimated-time-input').locator('input')
        self.description_input = page.get_by_test_id(
    ...
    def check_visible_empty_form(
        ...
        expect(self.estimate_time_input).to_be_visible()
        expect(self.estimate_time_input).to_have_value(estimated_time)
    ...
    def fill_form(
        ...
        self.estimate_time_input.fill(estimated_time)
        self.description_input.fill(description)
        self.max_score_input.fill(max_score)
        self.min_score_input.fill(min_score)


    def check_visible_filled_form(self,
            title: str,
            estimated_time: str,
            description: str,
            max_score: str,
