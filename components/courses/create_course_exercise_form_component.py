...
class CreateCourseExerciseFormComponent(BaseComponent):
    def __init__(self, page:Page):
        ...
        self.delete_button = Button(page,
            'create-course-exercise-{index}-box-toolbar-delete-exercise-button', "Delete button"
        )
        self.subtitle = Text(
    ...
    @allure.step('Check visible create course exercise form for index = {index}')
    ...
    @allure.step('Fill create course exercise form for index = {index}')
